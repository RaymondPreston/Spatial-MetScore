...
from .config import samples_dir as DEFAULT_SAMPLES_DIR, metadata_file as DEFAULT_METADATA_FILE, \
    high_genes_file as DEFAULT_HIGH_GENES_FILE, low_genes_file as DEFAULT_LOW_GENES_FILE

def analyze_sample(sample_id, samples_dir=DEFAULT_SAMPLES_DIR, metadata_file=DEFAULT_METADATA_FILE, 
                   high_genes_file=DEFAULT_HIGH_GENES_FILE, low_genes_file=DEFAULT_LOW_GENES_FILE,
